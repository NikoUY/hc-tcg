...
import {discardSingleUse, getAdjacentRows, rowHasEmptyItemSlot, rowHasItem} from '../../../../server/utils'
...
class PistonSingleUseCard extends SingleUseCard {
	...
	onApply(game, instance, pos, pickedSlots) {
		...
		discardSingleUse(game, pos.player)
	}
	...
	onAttach(game, instance, pos) {
        pos.player.hooks.availableActions[instance] = (availableActions) => {
		...
		pos.player.hooks.onApply[instance] = (game, instance, pos, pickedSlots) => {
			if (pos.player.custom[this.getInstanceKey(instance)]) {
				delete pos.player.hooks.availableActions[instance]
		...
		pos.player.hooks.turnEnd[instance] = () => {
			delete pos.player.hooks.turnEnd[instance]
			delete pos.player.hooks.availableActions[instance]
			delete pos.player.custom[this.getInstanceKey(instance)]
		}
    }
